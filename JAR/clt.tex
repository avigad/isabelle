...
\begin{quote}
 \todo{Insert definition of distr}.
\end{quote}
...
\begin{quote}
\todo{Insert definition of density from Nonnegative-Lebesgue-Integration.}
\end{quote}
...
\begin{quote}
 \todo{Insert the abbreviations for events, prob, random-variable, expectation, and variance defined in the file Probability-Measure.}
\end{quote}
...
\begin{quote}
\todo{Insert definition from distributions.}
\end{quote}
...
\begin{quote}
 \todo{Insert definition indep-sets from Independent-Families.}
\end{quote}
...
\begin{quote}
 \todo{Insert definition indep-events.}
\end{quote}
...
is independent.
\begin{quote}
 \todo{Insert definition indep-vars.}
\end{quote}
...
\begin{itemize}
 \item Textbooks allow $a$ to be $-\infty$ and $b$ to be $\infty$, which is to say, $a$ and $b$ should be taken to be extended real numbers.\fxnote{replace by extended non-negative real numbers}
...
\begin{quote}
\todo{insert integral-add and integrable-add from Bochner-integration}
\end{quote}
...
\begin{itemize}
 \item \verb=Bochner_Integral=: ??? lines
 \item \verb=Set_Integral=: ??? lines
 \item \verb=Interval_Integral=: ??? lines
\end{itemize}
In addition, the construction of Lebesgue-Stieltjes measure, described in Section~\ref{subsection:distribution:functions}, is found in \verb=Lebesgue_Measure= and requires about ??? lines. Some of the key background for the formalization is contained in the following files:
\begin{itemize}
 \item \verb=Distribution_Functions=: ??? lines
 \item \verb=Weak_Convergence=
 \item \verb=Sinc_Integral=: ??? lines
\end{itemize}
Also, general facts about the standard normal distribution take about about ??? lines in \texttt{Distributions}. The core development of characteristic functions and their properties, and the proof of the CLT, is found in the following files:
\begin{itemize}
 \item \verb=Characteristic_Functions=: ??? lines
 \item \verb=Helly_Selection=: ??? lines
 \item \verb=Levy=: ??? lines
 \item \verb=Central_Limit_Theorem=: ??? lines
\end{itemize}
