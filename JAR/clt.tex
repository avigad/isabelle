...
%\label{fig:clt}
%\end{figure}
Here, \isa{M} denotes the underlying probability space. We present a formal proof of the mean zero case in the appendix to this paper, and then derive the version above as a corollary.
...
\]
The formal proof is as follows:\footnote{We do not require finiteness of \isa{A}. If \isa{A} is infinite the sum over \isa{A} is $0$ and the product over \isa{A} is $1$ fulfilling the equation. }
