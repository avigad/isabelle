...
\emph{Acknowledgments.} We are grateful to Tobias Nipkow, Lawrence Paulson, Makarius Wenzel, and the entire Isabelle team for the ongoing development of Isabelle. We are especially grateful to Tobias in particular for steadfast encouragement and support.
...
The fundamentals of measure theory are found in the \texttt{HOL-Probability} library, including \texttt{Sigma\_Algebra}, \texttt{Measure\_Space}, \texttt{Carath\'eodory}, and \texttt{Lebesgue\_Measure}.
