...
It is not hard to see that the distribution function $F_\mu$ of a measure $\mu$ is nondecreasing and right-continuous, and satisfies $\lim_{x \rightarrow -\infty} F_\mu(x) = 0$.
