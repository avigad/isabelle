...
\ \ \ \ f\ {\isasymin}\ borel{\isacharunderscore}measurable\ M\ {\isasymand}\ {\isacharparenleft}{\isasymintegral}\isactrlsup {\isacharplus}x{\isachardot}\ norm\ {\isacharparenleft}f\ x{\isacharparenright}\ {\isasympartial}M{\isacharparenright}\ {\isacharless}\ {\isasyminfinity}{\isachardoublequoteclose}%
}%EndSnippet
