...
\begin{center}
\Large
  The \emph{Central Limit Theorem} says, in a sense, that the behavior of random or chaotic events becomes highly predictable when averaged over the long term. 
\end{center}
